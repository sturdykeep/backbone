...
class BackbonePlatform extends FlutterRustBridgeBase<BackboneWire> {
  BackbonePlatform(ffi.DynamicLibrary dylib) : super(BackboneWire(dylib));
...
class BackboneWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  BackboneWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  BackboneWire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
